(function(){
    ...
    var nav=[
		...
		{href:"",text:"Technical Topics",dropdown:[
			{href:"./examples/TopicDoc/SuperMapEarthFunctionTopic.html",text:"SuperMap Earth Functionality"},
			...
			{href:"./examples/TopicDoc/AttributeQueryofObliqueModel_OperateTopic.html",text:"Query attributes value of Oblique Image Model"},
            ...
            {href:"./webglreport.html",text:"WEBGL Report"}
    ];
